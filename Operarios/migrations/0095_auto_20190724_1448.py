# Generated by Django 2.1.2 on 2019-07-24 18:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Operarios', '0094_auto_20190724_1447'),
    ]

    operations = [
        migrations.CreateModel(
            name='HistRelevamientoDet',
            fields=[
                ...
                ('tipoServPart', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Operarios.TipoServicioParticular')),
                ('vactual', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Operarios.RelevamientoDet')),
            ],
        ),
