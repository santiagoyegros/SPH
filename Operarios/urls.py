...
urlpatterns = [
    ...
    #url(r'^jefes/asignar/(?P<id_user_jefe>\d+)/$', Jefes_asig, name='jefes_asigFiscales'),
    ...
    url(r'^fiscales/asignar/(?P<id_user_fiscal>\d+)/(?P<id_puntoServicio>\d+)/$', Fiscales_asig, name='fiscales_asig'),
