...
from Operarios.views import PuntosServicioList, PuntoServicioCreate, PuntosServicios_update, PuntoServicioDeleteView
...
urlpatterns = [
    ...
    url(r'^puntoServicio/editar/(?P<pk>\d+)/$', PuntosServicios_update, name='puntoServicio_update'),
    ...
    url(r'^fiscales/listar/', Fiscales_list, name='fiscales_list'),
